...
export const baseZones: Zone[] = [
  { id: "M", label: "Block M", ring: "outer", start: 214, end: 249, safeCapacity: 3600, expected: 2360, authenticated: 2332, observed: 2390, crowdRisk: 22, integrityRisk: 9, humanAlerts: 0, inflow: 86, outflow: 78, cctvConfidence: 0.9, gatewayHealth: 0.98, adjacent: ["N", "K", "D"], gates: ["G3"], cameras: [] },
  ...
  { id: "K", label: "Block K", ring: "outer", start: 178, end: 213, safeCapacity: 3400, expected: 2510, authenticated: 2479, observed: 2551, crowdRisk: 29, integrityRisk: 12, humanAlerts: 0, inflow: 94, outflow: 86, cctvConfidence: 0.91, gatewayHealth: 0.98, adjacent: ["J", "M", "C"], gates: ["G2"], cameras: [] },
